...
conn.onmessage = function(e) {
  let colors = ["#ce93d8", "#64b5f6", "#4db6ac", "#dce775", "#ff5252"]
   ...
   node.innerHTML = `<b style="color: #000; background-color:${colors[Math.floor(Math.random() * 4)]};  padding: 3px 5px; border-radius: 2px;">${user}</b>: ${msg}`
